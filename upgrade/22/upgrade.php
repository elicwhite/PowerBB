...
$db->query('UPDATE '.$db_prefix."config SET `conf_value` = '2.2.1' WHERE `conf_name` = 'o_cur_version'") or error('Unable to update table '.$db_prefix.'config. Please check your configuration and try again.');
...
?>
	...
	<div class="Banner">
      ...
      <div class="Body">
		<div class="Contents">
			<h1>PowerBB Upgrade Wizard</h1><p>You have successfully updated. Click the link below to continue the update proccess.</p>
